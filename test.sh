...
check_file "${DST_DIR}/test/1.0.0/download/linux/amd64/terraform-provider-test_v1.0.0_linux_amd64_SHA256SUMS"
check_file "${DST_DIR}/test/1.0.0/download/linux/amd64/terraform-provider-test_v1.0.0_linux_amd64_SHA256SUMS.sig"
...
check_file "${DST_DIR}/example/2.0.0/download/darwin/arm64/terraform-provider-example_v2.0.0_darwin_arm64_SHA256SUMS"
check_file "${DST_DIR}/example/2.0.0/download/darwin/arm64/terraform-provider-example_v2.0.0_darwin_arm64_SHA256SUMS.sig"
...
check_file "${DST_DIR}/nested/3.0.0/download/windows/386/terraform-provider-nested_v3.0.0_windows_386_SHA256SUMS"
check_file "${DST_DIR}/nested/3.0.0/download/windows/386/terraform-provider-nested_v3.0.0_windows_386_SHA256SUMS.sig"
